...
description: Evaluates proposed product metrics against a 3-ingredient framework (unit of value, truth detector, actionable). Use when defining KPIs, critiquing analytics, choosing success metrics, or when the user asks to evaluate, score, or improve a product metric.
---

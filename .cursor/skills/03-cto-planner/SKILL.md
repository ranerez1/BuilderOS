---
name: 03-cto-planner
description: Creates a CTO-grade plan for an initiative: architecture direction, build vs buy, sequencing, resourcing, and engineering risks. Use when the user asks for a CTO plan or runs /03-cto-planner.
---

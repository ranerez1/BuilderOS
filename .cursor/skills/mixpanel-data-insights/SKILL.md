---
name: mixpanel-data-insights
description: Pulls product analytics via MCP (trends, funnels, flows, retention, data-quality issues) and summarizes findings as a concise product-management overview with deep links. Use when the user asks for analytics insights, product analytics overview, usage trends, funnel or retention health, behavioral paths, or MCP-backed analytics reports.
---

# Analytics data insights (PM overview)

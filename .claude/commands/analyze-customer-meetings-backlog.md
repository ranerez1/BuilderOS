...
**Canonical spec:** [.cursor/skills/analyze-customer-meetings-backlog/SKILL.md](.cursor/skills/analyze-customer-meetings-backlog/SKILL.md) — follow that file for the full workflow and "AI analyzed" status column handling.
